...
*/
	...
	// 4 Uploading the file
		/*
			In recent years, the technology behind AJAX has evolved to be able to handle file uploads, so we take advantage of this to upload the file asynchronously.
			Benefits of asynchronous file uploading:
				- The ability to monitor the progress of the upload.
				- Allowing the user to perform additional actions while they wait for the upload to finish.
			
			We will use jQuery’s ajax method to perform the request
		*/
		function sendFile(fileData) {
			...
			$.ajax({
				...
				error: function (data) {
					alert('There was an error uploading your file in step 4!');
				}
			});
		};
